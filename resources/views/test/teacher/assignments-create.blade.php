...
<div class="content col-12">
	...
	<div class="form_container">
		<form method="POST" action="{{ route('teacher.assignments.store',['course_alias' => $courseAlias]) }}"  enctype="multipart/form-data">
			@csrf
			...
			<button type="submit" class="btn btn-send">Создать задание</button>
		</form>
	</div>
