...
<div class="content col-12">
	<div class="container">
		<div class="course_page">
			...
			<a class="btn btn-icon" href="{{ route('teacher.assignments.edit', ['course_alias' => $courseAlias, 'assignment' => $assignment['alias']]) }}">Редактировать</a>
			<p>{{ $assignment['description'] }}</p>
			<h3>Список вопросов</h3>
			<a class="btn btn-icon" href="{{ route('teacher.questions.create', ['course_alias' => $courseAlias, 'assignment' => $assignment['alias']]) }}">Создать вопрос</a>
